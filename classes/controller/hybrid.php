...
abstract class Controller_Hybrid extends \Controller
{
	...
	*/
	...
	{
		// set the proper response if none was passed
		if (empty($response))
		{
			$response = \Input::is_ajax() ? $this->response : $this->template;
		}
